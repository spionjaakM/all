...
public class GamePanel extends JPanel implements ActionListener{
	...
	GamePanel(int border,int contact,int grid,int rGlavaBoja,int gGlavaBoja,int bGlavaBoja,int rTijeloBoja,int gTijeloBoja,int bTijeloBoja,int glavaRGB,int tijeloRGB){
		this.border = border;
...
public void gameOver() {
	...
	if(glavaRGB == 1) {
		rGlavaBoja = random.nextInt(255);
		gGlavaBoja = random.nextInt(255);
		bGlavaBoja = random.nextInt(255);
	}
	
	if(tijeloRGB == 1) {
		rTijeloBoja = random.nextInt(255);
		gTijeloBoja = random.nextInt(255);
		bTijeloBoja = random.nextInt(255);
	}
